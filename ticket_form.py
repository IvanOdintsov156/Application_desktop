...
class TicketForm:
    def __init__(self, master,db, application_window, creation_time = None):
        ...
        self.entry_ticket_number.grid(row=0,column=1,sticky="e")
        ...
        self.fault_type = tk.Label(master, text="Тип неисправности:")
        ...
        self.problem_description = tk.Label(master, text="Описание проблемы:")
        ...
        self.status_dropdown.grid(row=5,column=0)
